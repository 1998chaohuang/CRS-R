...
public class Code {
    ...
    private static com.example.www44.memorandum.Code bmpCode;

    public static com.example.www44.memorandum.Code getInstance() {
        if(bmpCode == null)
            bmpCode = new com.example.www44.memorandum.Code();
        return bmpCode;
    }
